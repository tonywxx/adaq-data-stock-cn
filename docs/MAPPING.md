...
| `air_quality_hebei` | `src/air/air_html_gaps.rs::air_quality_hebei` | `air/air_hebei.py:23` | DONE |  |
...
| `sunrise_city_list` | `src/air/air_html_gaps.rs::sunrise_city_list` | `air/sunrise_tad.py:15` | DONE |  |
| `sunrise_daily` | `src/air/air_html_gaps.rs::sunrise_daily` | `air/sunrise_tad.py:40` | DONE |  |
| `sunrise_monthly` | `src/air/air_html_gaps.rs::sunrise_monthly` | `air/sunrise_tad.py:73` | DONE |  |
...
| `article_oman_rv` | `src/article/article_html_gaps.rs::article_oman_rv` | `article/risk_rv.py:18` | DONE |  |
| `article_oman_rv_short` | `src/article/article_html_gaps.rs::article_oman_rv_short` | `article/risk_rv.py:78` | DONE |  |
...
| `bond_cb_adj_logs_jsl` | `src/bond/bond_html_gaps.rs::bond_cb_adj_logs_jsl` | `bond/bond_convert.py:297` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `currency_boc_safe` | `src/currency/currency_html_gaps.rs::currency_boc_safe` | `currency/currency_safe.py:18` | DONE |  |
| `currency_boc_sina` | `src/currency/currency_html_gaps.rs::currency_boc_sina` | `currency/currency_china_bank_sina.py:57` | DONE |  |
...
| `macro_rmb_deposit` | `src/economic/economic_html_gaps.rs::macro_rmb_deposit` | `economic/macro_finance_ths.py:82` | DONE |  |
| `macro_rmb_loan` | `src/economic/economic_html_gaps.rs::macro_rmb_loan` | `economic/macro_finance_ths.py:50` | DONE |  |
...
| `macro_stock_finance` | `src/economic/economic_html_gaps.rs::macro_stock_finance` | `economic/macro_finance_ths.py:15` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `energy_carbon_bj` | `src/energy/energy_html_gaps.rs::energy_carbon_bj` | `energy/energy_carbon.py:76` | DONE |  |
| `energy_carbon_domestic` | — | `energy/energy_carbon.py:33` | DEFERRED | token/JS/HTML-gated |
| `energy_carbon_eu` | `src/energy/energy_html_gaps.rs::energy_carbon_eu` | `energy/energy_carbon.py:166` | DONE |  |
| `energy_carbon_gz` | `src/energy/energy_html_gaps.rs::energy_carbon_gz` | `energy/energy_carbon.py:242` | DONE |  |
| `energy_carbon_hb` | `src/energy/energy_html_gaps.rs::energy_carbon_hb` | `energy/energy_carbon.py:198` | DONE |  |
| `energy_carbon_sz` | `src/energy/energy_html_gaps.rs::energy_carbon_sz` | `energy/energy_carbon.py:134` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `forbes_rank` | `src/fortune/fortune_html_gaps.rs::forbes_rank` | `fortune/fortune_forbes_500.py:14` | DONE |  |
| `fortune_rank` | `src/fortune/fortune_html_gaps.rs::fortune_rank` | `fortune/fortune_500.py:40` | DONE |  |
| `hurun_rank` | `src/fortune/fortune_html_gaps.rs::hurun_rank` | `fortune/fortune_hurun.py:16` | DONE |  |
| `index_bloomberg_billionaires` | `src/fortune/fortune_html_gaps.rs::index_bloomberg_billionaires` | `fortune/fortune_bloomberg.py:65` | DONE |  |
| `index_bloomberg_billionaires_hist` | `src/fortune/fortune_html_gaps.rs::index_bloomberg_billionaires_hist` | `fortune/fortune_bloomberg.py:14` | DONE |  |
...
| `fund_aum_em` | `src/fund/fund_html_gaps.rs::fund_aum_em` | `fund/fund_aum_em.py:14` | DONE |  |
| `fund_aum_hist_em` | `src/fund/fund_html_gaps.rs::fund_aum_hist_em` | `fund/fund_aum_em.py:64` | DONE |  |
...
| `fund_etf_dividend_sina` | `src/fund/fund_html_gaps.rs::fund_etf_dividend_sina` |  | DONE |  |
| `fund_etf_fund_daily_em` | `src/fund/fund_html_gaps.rs::fund_etf_fund_daily_em` | `fund/fund_em.py:1064` | DONE |  |
...
| `fund_fee_em` | `src/fund/fund_html_gaps.rs::fund_fee_em` | `fund/fund_fee_em.py:17` | DONE |  |
...
| `fund_money_fund_daily_em` | `src/fund/fund_html_gaps.rs::fund_money_fund_daily_em` | `fund/fund_em.py:707` | DONE |  |
...
| `fund_overview_em` | `src/fund/fund_html_gaps.rs::fund_overview_em` | `fund/fund_overview_em.py:15` | DONE |  |
| `fund_portfolio_bond_hold_em` | `src/fund/fund_html_gaps.rs::fund_portfolio_bond_hold_em` | `fund/fund_portfolio_em.py:166` | DONE |  |
| `fund_portfolio_change_em` | `src/fund/fund_html_gaps.rs::fund_portfolio_change_em` | `fund/fund_portfolio_em.py:290` | DONE |  |
| `fund_portfolio_hold_em` | `src/fund/fund_html_gaps.rs::fund_portfolio_hold_em` | `fund/fund_portfolio_em.py:84` | DONE |  |
| `fund_portfolio_industry_allocation_em` | `src/fund/fund_html_gaps.rs::fund_portfolio_industry_allocation_em` | `fund/fund_portfolio_em.py:217` | DONE |  |
| `fund_purchase_em` | `fund/em.rs::fund_purchase_em` | `fund/fund_em.py:151` | DONE |  |
| `fund_rating_all` | `src/fund/fund_html_gaps.rs::fund_rating_all` | `fund/fund_rating.py:14` | DONE |  |
| `fund_rating_ja` | `src/fund/fund_html_gaps.rs::fund_rating_ja` | `fund/fund_rating.py:276` | DONE |  |
| `fund_rating_sh` | `src/fund/fund_html_gaps.rs::fund_rating_sh` | `fund/fund_rating.py:91` | DONE |  |
| `fund_rating_zs` | `src/fund/fund_html_gaps.rs::fund_rating_zs` | `fund/fund_rating.py:189` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `currency_pair_map` | `src/fx/fx_html_gaps.rs::currency_pair_map` | `fx/currency_investing.py:16` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `drewry_wci_index` | `src/index/index_html_gaps.rs::drewry_wci_index` | `index/index_drewry.py:17` | DONE |  |
...
| `index_detail_hist_adjust_cni` | `src/index/index_html_gaps.rs::index_detail_hist_adjust_cni` | `index/index_cni.py:191` | DONE |  |
...
| `index_stock_info` | `src/index/index_html_gaps.rs::index_stock_info` | `index/index_cons.py:70` | DONE |  |
...
| `sw_index_third_cons` | `src/index/index_html_gaps.rs::sw_index_third_cons` | `index/index_sw.py:220` | DONE |  |
| `sw_index_third_info` | `src/index/index_html_gaps.rs::sw_index_third_info` | `index/index_sw.py:158` | DONE |  |
...
| `option_cffex_hs300_list_sina` | `src/option/option_html_gaps.rs::option_cffex_hs300_list_sina` | `option/option_finance_sina.py:45` | DONE |  |
...
| `option_cffex_sz50_list_sina` | `src/option/option_html_gaps.rs::option_cffex_sz50_list_sina` | `option/option_finance_sina.py:28` | DONE |  |
...
| `option_cffex_zz1000_list_sina` | `src/option/option_html_gaps.rs::option_cffex_zz1000_list_sina` | `option/option_finance_sina.py:61` | DONE |  |
...
| `option_comm_info` | `src/option/option_html_gaps.rs::option_comm_info` | `option/option_comm_qihuo.py:38` | DONE |  |
| `option_comm_symbol` | `src/option/option_html_gaps.rs::option_comm_symbol` | `option/option_comm_qihuo.py:18` | DONE |  |
| `option_commodity_contract_sina` | `src/option/option_html_gaps.rs::option_commodity_contract_sina` | `option/option_commodity_sina.py:16` | DONE |  |
| `option_commodity_contract_table_sina` | `src/option/option_html_gaps.rs::option_commodity_contract_table_sina` | `option/option_commodity_sina.py:55` | DONE |  |
...
| `option_margin` | `src/option/option_html_gaps.rs::option_margin` | `option/option_margin.py:38` | DONE |  |
| `option_margin_symbol` | `src/option/option_html_gaps.rs::option_margin_symbol` | `option/option_margin.py:18` | DONE |  |
...
| `qhkc_tool_gdp` | `src/qhkc_web/qhkc_html_gaps.rs::qhkc_tool_gdp` | `qhkc_web/qhkc_tool.py:111` | DONE |  |
...
| `stock_info_change_name` | `src/stock/stock_html_gaps.rs::stock_info_change_name` | `stock/stock_info.py:411` | DONE |  |
...
| `stock_szse_sector_summary` | `src/stock/stock_html_gaps.rs::stock_szse_sector_summary` | `stock/stock_summary.py:110` | DONE |  |
...
| `stock_board_concept_info_ths` | `src/stock_feature/stock_feature_html_gaps.rs::stock_board_concept_info_ths` | `stock_feature/stock_board_concept_ths.py:91` | DONE |  |
...
| `stock_board_industry_info_ths` | `src/stock_feature/stock_feature_html_gaps.rs::stock_board_industry_info_ths` | `stock_feature/stock_board_industry_ths.py:88` | DONE |  |
...
| `stock_classify_board` | `src/stock_feature/stock_feature_html_gaps.rs::stock_classify_board` | `stock_feature/stock_classify_sina.py:17` | DONE |  |
...
| `stock_fhps_detail_ths` | `src/stock_feature/stock_feature_html_gaps.rs::stock_fhps_detail_ths` | `stock_feature/stock_fhps_ths.py:15` | DONE |  |
...
| `stock_lh_yyb_capital` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lh_yyb_capital` | `stock_feature/stock_lh_yybpm.py:42` | DONE |  |
| `stock_lh_yyb_control` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lh_yyb_control` | `stock_feature/stock_lh_yybpm.py:65` | DONE |  |
| `stock_lh_yyb_most` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lh_yyb_most` | `stock_feature/stock_lh_yybpm.py:19` | DONE |  |
| `stock_lhb_detail_daily_sina` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lhb_detail_daily_sina` | `stock_feature/stock_lhb_sina.py:18` | DONE |  |
| `stock_lhb_detail_em` | `stock/lhb.rs::stock_lhb_detail_em` | `stock_feature/stock_lhb_em.py:14` | DONE |  |
| `stock_lhb_ggtj_sina` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lhb_ggtj_sina` | `stock_feature/stock_lhb_sina.py:91` | DONE |  |
...
| `stock_lhb_jgmx_sina` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lhb_jgmx_sina` | `stock_feature/stock_lhb_sina.py:208` | DONE |  |
| `stock_lhb_jgstatistic_em` | `stock/lhb.rs::stock_lhb_jgstatistic_em` | `stock_feature/stock_lhb_em.py:335` | DONE |  |
| `stock_lhb_jgzz_sina` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lhb_jgzz_sina` | `stock_feature/stock_lhb_sina.py:166` | DONE |  |
...
| `stock_lhb_yytj_sina` | `src/stock_feature/stock_feature_html_gaps.rs::stock_lhb_yytj_sina` | `stock_feature/stock_lhb_sina.py:128` | DONE |  |
...
| `stock_market_activity_legu` | `src/stock_feature/stock_feature_html_gaps.rs::stock_market_activity_legu` | `stock_feature/stock_market_legu.py:18` | DONE |  |
...
| `stock_sns_sseinfo` | `src/stock_feature/stock_feature_html_gaps.rs::stock_sns_sseinfo` | `stock_feature/stock_sns_sseinfo.py:56` | DONE |  |
...
| akshare 函数 | 本库路径 | akshare 源文件:行 | 状态 | 原因 |
|---|---|---|---|---|
| `stock_add_stock` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_add_stock` | `stock_fundamental/stock_finance_sina.py:499` | DONE |  |
| `stock_circulate_stock_holder` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_circulate_stock_holder` | `stock_fundamental/stock_finance_sina.py:563` | DONE |  |
...
| `stock_fund_stock_holder` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_fund_stock_holder` | `stock_fundamental/stock_finance_sina.py:638` | DONE |  |
| `stock_history_dividend` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_history_dividend` | `stock_fundamental/stock_finance_sina.py:327` | DONE |  |
| `stock_history_dividend_detail` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_history_dividend_detail` | `stock_fundamental/stock_finance_sina.py:360` | DONE |  |
| `stock_hk_profit_forecast_et` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_hk_profit_forecast_et` | `stock_fundamental/stock_profit_forecast_hk_etnet.py:15` | DONE |  |
...
| `stock_institute_hold` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_institute_hold` | `stock_fundamental/stock_hold.py:17` | DONE |  |
| `stock_institute_hold_detail` | — | `stock_fundamental/stock_hold.py:58` | DEFERRED | token/JS/HTML-gated |
| `stock_institute_recommend` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_institute_recommend` | `stock_fundamental/stock_recommend.py:14` | DONE |  |
| `stock_institute_recommend_detail` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_institute_recommend_detail` | `stock_fundamental/stock_recommend.py:76` | DONE |  |
...
| `stock_ipo_hk_ths` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_ipo_hk_ths` | `stock_fundamental/stock_ipo_ths.py:81` | DONE |  |
| `stock_ipo_info` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_ipo_info` | `stock_fundamental/stock_finance_sina.py:483` | DONE |  |
| `stock_ipo_review_em` | `stock/fundamental/registration.rs::stock_ipo_review_em` | `stock_fundamental/stock_ipo_review.py:18` | DONE |  |
| `stock_ipo_ths` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_ipo_ths` | `stock_fundamental/stock_ipo_ths.py:14` | DONE |  |
...
| `stock_main_stock_holder` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_main_stock_holder` | `stock_fundamental/stock_finance_sina.py:696` | DONE |  |
| `stock_management_change_ths` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_management_change_ths` | `stock_fundamental/stock_finance_ths.py:574` | DONE |  |
...
| `stock_shareholder_change_ths` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_shareholder_change_ths` | `stock_fundamental/stock_finance_ths.py:622` | DONE |  |
...
| `stock_zyjs_ths` | `src/stock_fundamental/stock_fundamental_html_gaps.rs::stock_zyjs_ths` | `stock_fundamental/stock_zyjs_ths.py:14` | DONE |  |
